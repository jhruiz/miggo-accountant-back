...
(44,'VEHICULOS','vehiculos/index.html','lgM_VEHICULOS.png',42,0,7,'Podras crear el vehiculo segun tu tipo, modelo y linea; en caso que no este no exista en el software'),
...
(46,'TIPOS DE VEHICULOS','tipovehiculos/index.html','lgM_TIPOS DE VEHICULOS.png',44,0,7,'Este modulo es para caracterizar cada tipo de vehiculo, segun el taller automotriz en donde se atienden automoviles o motos es necesario crear todos los tipos de vehiculo del mercado'),
(47,'PARTES DE VEHICULOS','partevehiculos/index.html','lgM_PARTES DE VEHICULOS.png',45,0,7,'Este modulo complementa el modulo de VEHICULO, ahi se usa las partes que se requiera al momento de la creacion'),
...
(49,'MARCAS DE VEHICULOS','marcavehiculos/index.html','lgM_MARCAS DE VEHICULOS.png',46,0,7,'El usuario debe ingresar que marcas automoviles o motocicletas'),
